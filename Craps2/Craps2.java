   ...
   private static final int DOCE = 12;
    ...
    public static void main(String[] args)
    {
        ...
        while (saldoBanco > 0)
        {
            ...
            System.out.printf("Su saldo es de %d\n", saldoBanco);

            System.out.print("Ingrese su apuesta: ");
            apuestaJugador = input.nextInt();


             while(apuestaJugador > saldoBanco)
            {
                System.out.print("Saldo insuficiente para su apuesta. Intente nuevamente: ");
                apuestaJugador = input.nextInt();
            }

            System.out.printf("Su apuesta es de %d\n", apuestaJugador);
            ...
            if (estadoJuego == Estado.GANO)
            {
                ...
                saldoBanco = saldoBanco + apuestaJugador;
